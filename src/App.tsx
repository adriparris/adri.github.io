  ...
  return (
    <>
      <div className="flex w-full h-screen min-h-[794px]">
        <div className="flex p-5 text-sm w-full justify-between">
          <div className="flex-col"><h1>Adri Parris </h1>
          <h2 className="text-xs">Design Engineer</h2></div>
          <div className="flex">
            <a className="flex" href="">Resume <ArrowRight size={16} className="ml-1 mt-0.5" /></a>
          <a className="ml-2" href="mailto:adriparris.work@gmail.com">Contact</a></div> 
        </div>
